...
import { DatabaseError, SchemaError } from 'src/presentation/errorObjects';
import type { IRawUser, TUserRegisterController, TUserRegisterUseCase, IRequest } from 'src/domain/types';
